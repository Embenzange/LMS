...
from curriculum.forms import CommentForm, LessonForm, ReplyForm
from .models import Reply, Standard, Subject, Lesson, TimeSlots, WorkingDays
...
class LessonDetailView(DetailView, FormView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('curriculum:lesson_detail', kwargs={'standard':standard.slug, 'subject':subject.slug, 'slug':subject.slug})
...
class LessonCreateView(CreateView):
    ...
    def get_success_url(self):
        ...
        standard = self.object.standard
        subject = self.object.subject
        return reverse_lazy('curriculum:lesson_list', kwargs={'standard':standard.slug, 'subject':subject.slug, 'slug':self.object.slug})
